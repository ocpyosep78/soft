<?php
	$array_menu = array( 'menu' => array('Master', 'Category') );
?>
...
<script>
    $(document).ready(function() {
        ...
        $('#WinCategory .save').click(function() {
            ...
            param.action = 'update';
            Func.ajax({ url: web.host + 'panel/master/category/action', param: param, callback: function(result) {
                if (result.status == 1) {
        ...
        function init_table() {
            grid_category = $('#category').dataTable( {
                ...
                "sAjaxSource": web.host + 'panel/master/category/grid',
                "aoColumns": [
            ...
            $('#category').on('click','tbody td img.delete', function () {
                ...
                Func.confirm_delete({
                    ...
                    url: web.host + 'panel/master/category/action', grid: grid_category
                });
            });
        }
        init_table(); 
