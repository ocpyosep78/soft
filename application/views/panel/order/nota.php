...
<body>
	...
	<div id="maincontainer" class="clearfix">
        ...
        <div class="hide">
            <div class="status-nota-pending"><?php echo STATUS_NOTA_PENDING; ?></div>
            <div class="status-nota-confirm"><?php echo STATUS_NOTA_CONFIRM; ?></div>
	...
	<script>
		$(document).ready(function() {
            ...
            //nota status
            var nota_status_pending = $('div.status-nota-pending').text();
            var nota_status_confirm = $('div.status-nota-confirm').text();
            var nota_status_cancel = $('div.status-nota-cancel').text();
			...
			function init_table() {
                ...
                $('#nota').on('click','tbody td img.confirm', function () {
					...
					$('#WinNota [name="nota_country"]').val(record.nota_country);
					$('#WinNota [name="nota_currency_total"]').val(record.nota_currency_total);
					$('#WinNota [name="status_nota_id"]').val(nota_status_confirm);
