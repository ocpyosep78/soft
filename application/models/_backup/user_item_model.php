...
class User_Item_model extends CI_Model {
	function __construct() {
		...
		$this->field = array( 'id', 'user_id', 'item_id', 'nota_id' );
	}
	...
	function delete($param) {
		...
		} else if (isset($param['user_id']) && isset($param['nota_id'])) {
			$delete_query  = "DELETE FROM ".USER_ITEM." WHERE user_id = '".$param['user_id']."' AND nota_id = '".$param['nota_id']."'";
			$delete_result = mysql_query($delete_query) or die(mysql_error());
		}
