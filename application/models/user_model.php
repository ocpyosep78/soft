<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class User_model extends CI_Model {
		...
		function get_saldo($param) {
			...
			$result['saldo_dollar_at_rupiah'] = floor($result['kurs_dollar']['value'] * $result['saldo_dollar']);
			...
			$result['last_user_item_id'] = $this->User_Item_model->get_last_user_item_id(array( 'user_id' => $param['user_id'] ));
			$result['last_withdraw'] = $this->Withdraw_model->get_last_record(array( 'user_id' => $param['user_id'] ));
